...
const Footer = () => {
  ...
  return (
    <footer>
      ...
      {/* Zalo plugin */}
      <a href="https://chat.zalo.me/?phone=0856779886" id="linkzalo" target="_blank" rel="noopener noreferrer">
        ...
        <div className="fcta-zalo-vi-tri-nut">
          <div id="fcta-zalo-tracking" className="fcta-zalo-nen-nut">
            <div id="fcta-zalo-tracking" className="fcta-zalo-ben-trong-nut">
              ...
              </svg></div><div id="fcta-zalo-tracking" className="fcta-zalo-text">Chat ngay</div></div></div></a>
    </footer>
  );
};
